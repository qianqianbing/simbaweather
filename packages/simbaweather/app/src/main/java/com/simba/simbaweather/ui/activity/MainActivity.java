...
public class MainActivity extends BaseActivity<WeatherShowContract.IWeatherShowView, WeatherShowPresenter<WeatherShowContract.IWeatherShowView>> implements WeatherShowContract.IWeatherShowView {
    ...
    protected void initData() {
        ...
        gpsLocation = LocationUtils.getGPSLocation(this);
        ...
        if (gpsLocation == null) {
            mPresenter.WeathershowRequestData("" + 32.298741, "" + 118.840485);
        } else {
            mPresenter.WeathershowRequestData("" + best.getAltitude(), "" + best.getLongitude());
        }
    ...
    public void WeatherShowData(Response<WeaTher.DataBean> response) {
        ...
        //设置自定义分割线
        rvWeather.addItemDecoration(new RecyclerViewDivider(this, LinearLayoutManager.HORIZONTAL, R.drawable.itemdecoration));
...
//                2020-03-23 19:32
            ...
            case R.id.tv_runacity:
                Intent intent = new Intent(MainActivity.this, RuncityActivity.class);
