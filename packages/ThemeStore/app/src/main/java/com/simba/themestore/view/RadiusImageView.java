...
public class RadiusImageView extends AppCompatImageView {
    ...
    public RadiusImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSelectedBorderColor = array.getColor(
                R.styleable.RadiusImageView_selected_border_color, mBorderColor);
        mSelectedMaskColor = array.getColor(
                R.styleable.RadiusImageView_selected_mask_color, Color.TRANSPARENT);
        ...
        mIsTouchSelectModeEnabled = array.getBoolean(
                R.styleable.RadiusImageView_is_touch_select_mode_enabled, true);
        ...
        if (!mIsOval) {
            mCornerRadius = array.getDimensionPixelSize(
                    R.styleable.RadiusImageView_corner_radius, 0);
        }
        array.recycle();
    }
