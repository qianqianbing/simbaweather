...
public class ViewPagerIndicator extends View {
    ...
    private void setStyleable(Context context, AttributeSet attrs) {
        ...
        mDefault_color = array.getColor(R.styleable.ViewPagerIndicator_vpi_default_color, 0xffffffff);
        mRadius = array.getDimension(R.styleable.ViewPagerIndicator_vpi_radius, 5);//px
        mRadiusSelected = array.getDimension(R.styleable.ViewPagerIndicator_vpi_radius_selected, 5);//px
        mLength = array.getDimension(R.styleable.ViewPagerIndicator_vpi_length, 88);//px
        mDistance = array.getDimension(R.styleable.ViewPagerIndicator_vpi_distance, 10);//px
        mDistanceType = array.getInteger(R.styleable.ViewPagerIndicator_vpi_distanceType, DistanceType.BY_RADIUS);
        mIndicatorType = array.getInteger(R.styleable.ViewPagerIndicator_vpi_indicatorType, IndicatorType.CIRCLE_LINE);
     ...
     * @return
     */
    public ViewPagerIndicator setViewPager(ViewPager2 viewPager) {
     ...
     * @return
     */
    public ViewPagerIndicator setViewPager(ViewPager2 viewpager, int CycleNumber) {
    ...
    /**
     * @param viewPager        适配的viewpager
     * @param isInfiniteCircle 真无限循环 配合BannerView 通常是true;false为一般 不循环 固定等价于{@link #setViewPager(ViewPager2 viewPager)}
     * @return
     */
    public ViewPagerIndicator setViewPager(ViewPager2 viewPager, boolean isInfiniteCircle) {
     ...
     * @return
     */
    public ViewPagerIndicator setViewPager(ViewPager2 viewpager, int CycleNumber, boolean isInfiniteCircle) {
        mNum = CycleNumber;
