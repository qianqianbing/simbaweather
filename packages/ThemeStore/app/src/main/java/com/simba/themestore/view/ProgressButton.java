...
public class ProgressButton extends View implements Runnable {
 ...
 //   private float flickerLeft;
    ...
    private void initAttrs(AttributeSet attrs) {
        TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.ButtonProgress);
        try {
            textSize = (int) ta.getDimension(R.styleable.ButtonProgress_textSize, 12);
            loadingColor = ta.getColor(R.styleable.ButtonProgress_loadingColor, Color.parseColor("#40c4ff"));
            stopColor = ta.getColor(R.styleable.ButtonProgress_stopColor, Color.parseColor("#ff9800"));
            radius = (int) ta.getDimension(R.styleable.ButtonProgress_radius, 0);
            borderWidth = (int) ta.getDimension(R.styleable.ButtonProgress_borderWidth, 1);
        } finally {
            ta.recycle();
        }
    }
