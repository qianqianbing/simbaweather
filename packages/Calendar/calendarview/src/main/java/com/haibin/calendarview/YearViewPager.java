 ...
 */
public final class YearViewPager extends VerticalViewPager {
    ...
    void setup(CalendarViewDelegate delegate) {
        ...
        if (titleYear != null) {
            titleYear.setText(getCurrentItem() + mDelegate.getMinYear() + "年");
        }
        addOnPageChangeListener(new OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                if (titleYear != null)
                    titleYear.setText(position + mDelegate.getMinYear() + "年");
            }
...
//        heightMeasureSpec = MeasureSpec.makeMeasureSpec(getHeight(getContext(), this), MeasureSpec.EXACTLY);
     ...
     * @param titleYear
     */
    public void setTitleYear(TextView titleYear) {
    ...
    public void setVisibility(int visibility) {
        ...
        if (titleYear != null)
            titleYear.setVisibility(visibility);
    }
}
